...
describe('HotelsService', () => {
    ...
    it('returns empty-safe hotel listing', async () => {
        ...
        const result = await service.getHotels({ page: 1, limit: 10, search: {} } as any);
    ...
    it('toggles like on active hotel', async () => {
        ...
        const result = await service.likeTargetHotel(new Types.ObjectId(), hotelId as any);
    ...
    it('delegates favorite hotels query', async () => {
        ...
        const result = await service.getFavoriteHotels(new Types.ObjectId(), { page: 1, limit: 10 } as any);
    ...
    it('updates hotel by admin', async () => {
        ...
        const result = await service.updateHotelByAdmin({ _id: updated._id, hotelName: 'Updated' } as any);
