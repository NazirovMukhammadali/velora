...
describe('FlightsService', () => {
    ...
    it('returns empty-safe flights list', async () => {
        ...
        const result = await service.getFlights({ page: 1, limit: 10, search: {} } as any);
    ...
    it('updates flight by admin with validation', async () => {
        ...
        const result = await service.updateFlightByAdmin({ _id, airline: 'Updated Air' } as any);
    ...
    it('soft deletes flight by admin', async () => {
        ...
        const result = await service.removeFlightByAdmin(_id as any);
