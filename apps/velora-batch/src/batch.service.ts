...
import { Member } from 'apps/velora-api/src/libs/dto/member/member';
import { Property } from 'apps/velora-api/src/libs/dto/property/property';
import { MemberStatus, MemberType } from 'apps/velora-api/src/libs/enums/member.enum';
import { PropertyStatus } from 'apps/velora-api/src/libs/enums/property.enum';
...
export class BatchService {
	...
	public getHello(): string {
		return 'Welcome to Velora BATCH Server!';
	}
}
